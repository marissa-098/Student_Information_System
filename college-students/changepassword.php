...
.success {
 ...
 <div class="page-header">
  ...
  if (!passwordRegex.test(newPassword)) {
    showMessage('error', 'Password must be at least 8 characters long, combination of numbers, uppercase and lowercase characters, and have atleast 1 special character.');
    return false;
  }

  // Proceed with AJAX request to update the password
  var formData = {
