                                     ...
                                     <table  class="table table-bordered table-striped">
                                        <tr>
                                             ...
                                             <?php 
                                              ...
                                              SELECT * FROM `tblsiacct` WHERE `StudNum`='$st_id' ORDER BY AcadYr Desc LIMIT 1");
                                              $select_acc->execute();
                                         ...
                                         <div class="col-xl-4 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-purple"><?= $fetch_acc['Unit']-$fetch_acc['Lab'] ; ?></h4>
                                                                <h6 class="text-muted m-b-0">Total Lecture</h6>
                                                            </div>
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-purple"><?= $fetch_acc['Lab']; ?></h4>
                                                                <h6 class="text-muted m-b-0">Total Laboratory</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-purple"><?= $fetch_acc['Unit']; ?></h4>
                                                                <h6 class="text-muted m-b-0">Total Units</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                                <i class="ti-book f-28"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-c-green">
                                                ...
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-6 text-right">
                                                                 <h4 class="text-c-purple">&#8369; <?= number_format($fetch_acc['Misc'], 2); ?></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-6 text-right">
                                                                <h4 class="text-c-purple">&#8369; <?= number_format($fetch_acc['LabFee'], 2); ?></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-6 text-right">
                                                               <h4 class="text-c-purple">&#8369; <?= number_format($fetch_acc['OJT'], 2); ?></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-block  bg-c-custom-green">
                                                        <div class="row align-items-center">
                                                            <div class="col-5">
                                                             ...
                                                             <div class="col-6 text-right">
                                                               <h4 class="text-c-purple">&#8369; <?= number_format($fetch_acc['ROTC'], 2); ?></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-block">
                                                     ...
                                                     <div class="card-block bg-c-custom-green">
                                                        <div class="row align-items-center">
                                                            <div class="col-5">
                                                                <h6 class="text-muted m-b-0">Special Class</h6>
                                                            </div>
                                                             <div class="col-6 text-right">
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-5">
                                                                <h6 class="text-muted m-b-0">Total Accounts</h6>
                                                            </div>
                                                             <div class="col-6 text-right">
                                                               <h4 class="text-c-purple">&#8369; <?= number_format($fetch_acc['TotalAcct'], 2); ?></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-block  bg-c-custom-green">
                                                        <div class="row align-items-center">
                                                            <div class="col-5">
                                                             ...
                                                             <div class="col-6 text-right">
                                                               <h4 class="text-c-purple">&#8369; <?= number_format($fetch_acc['DiscountAmt'], 2); ?></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-block">
