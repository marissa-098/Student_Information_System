    ...
    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                                ...
                                <div class="main-menu-header">
                                    ...
                                    <div class="user-details">
                                        <span id="more-details">
                                            <?= $fetch_stud['Lname']; ?>,
                                            <?= $fetch_stud['Fname']; ?>
                                            <?= $fetch_stud['Mname']; ?><i class="fa fa-caret-down"></i></span>
                                    </div>
                                </div>
                                <?php }}?>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="nav-link nav-prospectus">
                                    <a href="./index.php?page=prospectus" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layout-media-overlay-alt-2"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Prospectus</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
