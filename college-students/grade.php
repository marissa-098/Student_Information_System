        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h3 class="m-b-8"><i class="fa fa-graduation-cap"></i> GRADES</h3>
                </div>
            </div>
            <div class="col-md-4">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="#!">Grades</a>
                    </li>
                </ul>
            </div>
        </div>
                     ...
                     <!-- Print RECORDS -->
                          <div  style="display:none;" id="printableContent">
                                ...
                                <div id="registrar">
                                    ...
                                    <p  class=" f-mnt-B f-black f-15 f-b f-k1"> STUDENT GRADE <br>
									<p id="YearandSem"></p>									
                                </div>
...
function displayInformation1(selectedValue) {
    if (selectedValue == "0") {
       ...
       var values = selectedValue.split(',');
        ...
        xhttp.open("GET", "grades/fetch.php?tblsem=" + tblsem + "&tblsubrpt=" + tblsubrpt + "&studID=" + stId + "&YearLevel=" + YearLevel + "&section=" + section, true);
        xhttp.send();
...
function printInformation() {
    ...
    printWindow.document.write('<html><head><title>Student Grade</title></head><body>');
  ...
  // Inject the fetched information into the print window
    printWindow.document.write('<div>' + document.getElementById('printableContent').innerHTML + ' </div><div id="GradeTbl">' + document.getElementById('GradeTbl').innerHTML + '</div><div>' + document.getElementById('printableContent2').innerHTML + ' </div>');
