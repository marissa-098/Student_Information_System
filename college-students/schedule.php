            ...
            <div class="page-body">
                        ...
                        <div class="card">
                            ...
                            <div class="d-flex align-self-center">
                                ...
                                <button id="printSched" class="m-2 mx-1 btn btn-mat waves-effect waves-light btn-success">Print</button>
                            </div>
                        </div>
                        <div class="card">
...
function printInformation() {
    ...
    printWindow.document.write('<html><head><title>Student Schedule</title></head><body>');
...
document.getElementById('printSched').addEventListener('click', function () {
