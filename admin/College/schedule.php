  ...
  <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                             <h2 class="pageheader-title"><span class="material-symbols-outlined">calendar_today</span>Student's Schedule </h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="./index.php" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="./index.php?page=college_list" class="breadcrumb-link">College</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"> student schedule</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        ?>
                            ...
                            <div class="student-info">
                                ...
                                <div>
                                    ...
                                    <p><strong>YR. & Sec:</strong> <?= $fetch_stud['YrlLevel']; ?>-<?= $fetch_stud['Sec']; ?></p>
                                </div>
                            </div>
...
function displayInformation1(selectedValue) {
    if (selectedValue == "0") {
       ...
       var values = selectedValue.split(',');
        ...
        xhttp.open("GET", "College/getSchedule.php?tblsem=" + tblsem + "&tblsubrpt=" + tblsubrpt + "&studID=" + stId + "&YearLevel=" + YearLevel + "&section=" + section, true);
        xhttp.send();
