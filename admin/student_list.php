		  ...
		  <div class="page-breadcrumb col-md-4 p-t-20">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"> Grade school</li>
							</ol>
						</nav>
					</div>
			  <div class="col-md-8">
...
<script type="text/javascript">
 $(document).ready(function () {
    ...
    function openModal(studentId) {
        ...
        $.ajax({
            url: 'students/get_student_details.php', // replace with your endpoint
            method: 'POST',
            data: {
                studentId: studentId
            },
